...
app = Flask(__name__)
# আপনার দেওয়া app.secret_key এখানে বসানো হয়েছে
app.secret_key = "SAMIR HOSTING PANEL"
...
def load_db():
    # এখানে কোডটি পরিবর্তন করা হয়েছে, যেন পুরনো ফাইল থাকলেও আপনার নতুন পাসওয়ার্ডটিই সবসময় সেট হয়
    if not os.path.exists(DB_FILE):
        default = {"user_pw": "ADMIN_SAMIR123", "users": {}, "start_times": {}}
        with open(DB_FILE, "w") as f: json.dump(default, f)
        return default
    with open(DB_FILE, "r") as f:
        try:
            data = json.load(f)
            data["user_pw"] = "ADMIN_SAMIR123"  # আপনার নতুন পাসওয়ার্ড জোরপূর্বক সেট করা হলো
            if "users" not in data: data["users"] = {}
            if "start_times" not in data: data["start_times"] = {}
            return data
        except:
            return {"user_pw": "ADMIN_SAMIR123", "users": {}, "start_times": {}}
...
# আপনার দেওয়া ADMIN_PASS এখানে আপডেট করা হয়েছে
ADMIN_PASS = "ADMIN_SAMIR123"
...
<head>
    ...
    <title>Login | SAMIR PREMIUM HOSTING</title>
...
<body>
    ...
    <div class="rgb-border-box">
        <div class="login-card">
            ...
            <div class="get-pw"><a href="https://t.me/samir_mals_bd" target="_blank"><i class="fa-brands fa-telegram"></i> FORGOT PASSWORD?</a></div>
        </div>
    </div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Admin Root | SAMIR PREMIUM HOSTING</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
...
<body>
    ...
    <div class="header"><h2><i class="fa-solid fa-shield-halved"></i> SAMIR ROOT PANEL</h2><a href="/logout" class="btn btn-logout"><i class="fa-solid fa-power-off"></i></a></div>
...
def upload():
    ...
    if file and file.filename.endswith(".zip"):
        app_name = file.filename.rsplit('.', 1)
        user_dir = os.path.join(UPLOAD_FOLDER, user_name)
